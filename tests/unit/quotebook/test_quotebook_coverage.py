...
async def test_list_exception(cog):
    ...
    i.followup.send.assert_awaited_with("❌ Error listing quotes.", ephemeral=True)
...
async def test_submit_exception(cog):
    ...
    i.followup.send.assert_awaited_with("❌ Error submitting quote.", ephemeral=True)
...
async def test_approve_exception_outer(cog):
    ...
    i.followup.send.assert_awaited_with("❌ Error approving quote.", ephemeral=True)
...
async def test_delete_exception(cog):
    ...
    i.followup.send.assert_awaited_with("❌ Error deleting quote.", ephemeral=True)
...
async def test_random_exception(cog):
    ...
    i = mock_interaction()
    await cog.quote_group.random_cmd.callback(cog.quote_group, i)
    i.followup.send.assert_awaited_with("❌ Error fetching quote.", ephemeral=True)
