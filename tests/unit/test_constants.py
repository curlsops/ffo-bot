...
class TestRole:
    ...
    def test_role_hierarchy_ordering(self):
        """Test role hierarchy ordering is correct."""
...
class TestConstants:
    ...
    def test_database_retention_constants(self):
        """Test database retention constants."""
    ...
    def test_cache_ttl_constants(self):
        ...
        assert Constants.NOTIFIARR_EVENT_CACHE_TTL == 300
